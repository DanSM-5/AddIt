...
class Game extends React.Component {
  ...
  constructor(props) {
    ...
    [this.target, this.randomNumbers, this.randomSelection] =
      numbersSetGenerator(this.difficultySettings);
  }
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.state.gameStatus !== PLAYING) {
      ...
      if (this.state.gameStatus === WON && prevState.gameStatus === PLAYING) {
  ...
  unselectNumber = (index) => {
    this.setState((prevState, props) => {
      return {
        selectedIds: prevState.selectedIds.reduce((acc, curr) => {
          if (curr === index) {
            return [...acc];
          }
          return [...acc, curr];
